...
<section class="grid grid__two-column demo">
	...
	<section>
		<div class="input-wrap input-wrap--inline"><label><span class="icon fa fa-lock"></span></label><input type="text" placeholder="Placeholder Text" read-only/></div>
