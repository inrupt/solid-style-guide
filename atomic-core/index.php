                    ...
                    <ul class="nav-atomic nav-tabs-atomic" role="tablist">
                        ...
                        <?php } else { ?>
                            ...
                            <form method="post" class="formGroup-check tabForm form-create-jsfile" action="atomic-core/temp-processing/temp-create-jsfile.php">
                                ...
                                <input type="hidden" name="catVal" value="<?php echo htmlspecialchars($_GET['cat']); ?>">
...
<section class="banner-wrap--footer banner">
    ...
    <a href="https://github.com/inrupt/solid-style-guide" rel="noopener noreferrer" target="_blank"><i class="icon fa fa-github"></i> View on Github</a></div>
</section>
