            ...
            <ul class="list searchList">
                ...
                foreach ($categories as $category) {
                    ...
                    <?php foreach ($filtered as $component) { ?>
                        ...
                        <li>
                            <a class="name"
                               href="atomic-core/#<?php echo $category['category'] ?>/<?php echo $component['component'] ?>"><?php echo $component['component'] ?></a>
                        </li>
                    ...
                    foreach ($categories as $category) {
                        ...
                        <div class="aa_dir__dirNameGroup">
                            ...
                            <a class="aa_dir__dirNameGroup__name"
                               ...
                               href="atomic-core/#<?php echo $category['category'] ?>"><?php echo $category['category'] ?></a>
                        </div>
                        ...
                        <ul class="aa_fileSection fileSection-<?php echo $category['category'] ?>">
                            ...
                            <?php foreach ($filtered as $component) { ?>
                                ...
                                <li class="aa_fileSection__file" data-comp="<?php echo $component['component'] ?>"
                                    ...
                                    <a href="atomic-core/#<?php echo $category['category'] ?>#<?php echo $component['component'] ?>"><?php echo $component['component'] ?></a>
                                </li>
            ...
            <?php if (!empty($_GET['search'])) { ?>
                ...
                <?php if (!empty($cat)) { ?>
                    <h1 id="modules" class="atomic-h1">The <a
                            href="atomic-core/#<?php echo $cat ?>#<?php echo $_GET['search']; ?>"> <?php echo $_GET['search']; ?></a>
                        component was found in the
                        <a href="atomic-core/#<?php echo $cat ?>"><?php echo $cat ?></a> category.</h1>
                <?php } ?>
